 ...
 * 
 * <p>Clase Java para GetInfoPricingMode complex type.
 * 
 * <p>El siguiente fragmento de esquema especifica el contenido que se espera que haya en esta clase.
 * 
 * <pre>
 * &lt;complexType name="GetInfoPricingMode"&gt;
 *   &lt;complexContent&gt;
 *     &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType"&gt;
 *       &lt;sequence&gt;
 *         &lt;group ref="{http://ws.amadeus.fr/air}PricingModeGroup"/&gt;
 *         &lt;element name="pricingsByItineraryGroup" type="{http://ws.amadeus.fr/air}GetInfoRequestPricingsByItineraryGroup"/&gt;
 *       &lt;/sequence&gt;
...
@XmlType(name = "GetInfoPricingMode", propOrder = {
    "pointOfSell",
    "pointOfTicketing",
    "pricingsByItineraryGroup"
})
public class GetInfoPricingMode implements Serializable
{

    protected IataLocation pointOfSell;
    protected IataLocation pointOfTicketing;
    @XmlElement(required = true)
    protected GetInfoRequestPricingsByItineraryGroup pricingsByItineraryGroup;
     ...
     * 
     */
    public GetInfoPricingMode(final IataLocation pointOfSell, final IataLocation pointOfTicketing, final GetInfoRequestPricingsByItineraryGroup pricingsByItineraryGroup, final CurrencyCode currencyCode) {
     ...
     * @return
     *     possible object is
     *     {@link GetInfoRequestPricingsByItineraryGroup }
     *     
     */
    public GetInfoRequestPricingsByItineraryGroup getPricingsByItineraryGroup() {
     ...
     *     
     */
    public void setPricingsByItineraryGroup(GetInfoRequestPricingsByItineraryGroup value) {
