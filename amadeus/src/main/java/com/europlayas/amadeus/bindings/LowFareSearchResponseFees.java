 ...
 * 
 * <p>Clase Java para LowFareSearchResponseFees complex type.
 * 
 * <p>El siguiente fragmento de esquema especifica el contenido que se espera que haya en esta clase.
 * 
 * <pre>
 * &lt;complexType name="LowFareSearchResponseFees"&gt;
 *   &lt;complexContent&gt;
...
@XmlType(name = "LowFareSearchResponseFees", propOrder = {

})
public class LowFareSearchResponseFees implements Serializable
{
     ...
     * 
     */
    public LowFareSearchResponseFees() {
        super();
    }
     ...
     * 
     */
    public LowFareSearchResponseFees(final CurrencyAmount supplierFee, final CurrencyAmount paymentCardFee, final CurrencyAmount ticketingServiceFee) {
