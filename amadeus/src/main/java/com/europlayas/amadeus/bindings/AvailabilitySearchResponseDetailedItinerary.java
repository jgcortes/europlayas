...
public class AvailabilitySearchResponseDetailedItinerary implements Serializable
{
    ...
    public static class Segments implements Serializable
    {
        ...
        protected List<AvailabilitySearchResponseDetailedSegment> segments;
         ...
         * 
         */
        public Segments(final List<AvailabilitySearchResponseDetailedSegment> segments) {
            this.segments = segments;
        }
         ...
         * 
         */
        public List<AvailabilitySearchResponseDetailedSegment> getSegments() {
            if (segments == null) {
                segments = new ArrayList<AvailabilitySearchResponseDetailedSegment>();
            }
