...
public class SearchPassengerPricingSegmentDetailList implements Serializable
{

    @XmlElement(name = "segmentDetail", required = true)
    protected List<SearchPassengerPricingSegmentDetail> segmentDetails;
     ...
     * 
     */
    public SearchPassengerPricingSegmentDetailList(final List<SearchPassengerPricingSegmentDetail> segmentDetails) {
     ...
     * 
     */
    public List<SearchPassengerPricingSegmentDetail> getSegmentDetails() {
        if (segmentDetails == null) {
            segmentDetails = new ArrayList<SearchPassengerPricingSegmentDetail>();
        }
