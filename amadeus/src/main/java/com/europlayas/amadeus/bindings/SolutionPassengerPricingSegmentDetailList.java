...
public class SolutionPassengerPricingSegmentDetailList implements Serializable
{

    @XmlElement(name = "segmentDetail", required = true)
    protected List<SolutionPassengerPricingSegmentDetail> segmentDetails;
     ...
     * 
     */
    public SolutionPassengerPricingSegmentDetailList(final List<SolutionPassengerPricingSegmentDetail> segmentDetails) {
     ...
     * 
     */
    public List<SolutionPassengerPricingSegmentDetail> getSegmentDetails() {
        if (segmentDetails == null) {
            segmentDetails = new ArrayList<SolutionPassengerPricingSegmentDetail>();
        }
