...
public class GetInfoResponsePassengerPricingSegmentDetailList {

    @XmlElement(required = true)
    protected List<GetInfoResponsePassengerPricingSegmentDetail> segmentDetail;
     ...
     * 
     */
    public GetInfoResponsePassengerPricingSegmentDetailList(final List<GetInfoResponsePassengerPricingSegmentDetail> segmentDetail) {
     ...
     * 
     */
    public List<GetInfoResponsePassengerPricingSegmentDetail> getSegmentDetail() {
        if (segmentDetail == null) {
            segmentDetail = new ArrayList<GetInfoResponsePassengerPricingSegmentDetail>();
        }
