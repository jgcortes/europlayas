...
public class SearchPassengerPricingList implements Serializable
{

    @XmlElement(name = "passengerPricing", required = true)
    protected List<SearchPassengerPricing> passengerPricings;
     ...
     * 
     */
    public SearchPassengerPricingList(final List<SearchPassengerPricing> passengerPricings) {
     ...
     * 
     */
    public List<SearchPassengerPricing> getPassengerPricings() {
        if (passengerPricings == null) {
            passengerPricings = new ArrayList<SearchPassengerPricing>();
        }
