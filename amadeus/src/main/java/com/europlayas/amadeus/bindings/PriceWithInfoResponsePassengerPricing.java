 ...
 * 
 * <p>Clase Java para PriceWithInfoResponsePassengerPricing complex type.
 * 
 * <p>El siguiente fragmento de esquema especifica el contenido que se espera que haya en esta clase.
 * 
 * <pre>
 * &lt;complexType name="PriceWithInfoResponsePassengerPricing"&gt;
 *   &lt;complexContent&gt;
 *     &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType"&gt;
 *       &lt;sequence&gt;
 *         &lt;group ref="{http://ws.amadeus.fr/air}PassengerPricingGroup"/&gt;
 *         &lt;element name="segmentDetails" type="{http://ws.amadeus.fr/air}PriceWithInfoResponsePassengerPricingSegmentDetailList"/&gt;
 *       &lt;/sequence&gt;
...
@XmlType(name = "PriceWithInfoResponsePassengerPricing", propOrder = {
    "amount",
    "amountWithoutTax",
    "taxes",
    "segmentDetails"
})
public class PriceWithInfoResponsePassengerPricing implements Serializable
{
    ...
    protected PriceWithInfoResponsePassengerPricingSegmentDetailList segmentDetails;
     ...
     * 
     */
    public PriceWithInfoResponsePassengerPricing() {
        super();
    }
     ...
     * 
     */
    public PriceWithInfoResponsePassengerPricing(final CurrencyAmount amount, final CurrencyAmount amountWithoutTax, final TaxList taxes, final PriceWithInfoResponsePassengerPricingSegmentDetailList segmentDetails, final FareOption fareOption, final int passengerId) {
        this.amount = amount;
     ...
     * @return
     *     possible object is
     *     {@link PriceWithInfoResponsePassengerPricingSegmentDetailList }
     *     
     */
    public PriceWithInfoResponsePassengerPricingSegmentDetailList getSegmentDetails() {
     ...
     *     
     */
    public void setSegmentDetails(PriceWithInfoResponsePassengerPricingSegmentDetailList value) {
